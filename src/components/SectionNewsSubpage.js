    ...
    return (
        <Section id='aktualnosci' name='subpage'>
            <Row className='align-items-stretch'>
                <News title='Przychodnia nieczynna 15.08 z powodu choroby' date='5.08.2020' 
                text='Teraz tu jestem i zamierzam napisać pewną wiadomość na temat pierwszej aktualności jeśli tylko mi się uda ponieważ zamierzam sprawdzić ile tekstu rzeczywiście tu zostanie widoczne. Chcę wiedzieć ile tekstu rzeczywiście się wyświetlia ile nieTeraz tu jestem i zamierzam napisać pewną wiadomość na temat pierwszej aktualności jeśli tylko mi się uda ponieważ zamierzam sprawdzić ile tekstu rzeczywiście tu zostanie widoczne. Chcę wiedzieć ile tekstu rzeczywiście się wyświetlia ile nieTeraz tu jestem i zamierzam napisać pewną wiadomość na temat pierwszej aktualności jeśli tylko mi się uda ponieważ zamierzam sprawdzić ile tekstu rzeczywiście tu zostanie widoczne. Chcę wiedzieć ile tekstu rzeczywiście się wyświetlia ile nie' />
